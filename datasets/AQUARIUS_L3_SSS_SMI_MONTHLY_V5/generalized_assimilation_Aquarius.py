...
if __name__== "__main__":
    ...
    # data names
    product_name = 'L3m_MO_SCI_V5.0_SSS_1DEG'
    product_source = 'aquarius_generalized'
    ...
    # fields to process
    data_field_0 = {'name':'SSS',
                    'long_name':'Sea Surface Salinity',
                    'standard_name':'sea_surface_salinity',
                    'units':'N/A'}
    
    data_field_1 = {'name':'SSS_sys_unc',
    ...
    new_data_attr = {'original_dataset_title':'Aquarius Official Release Level 3 Sea Surface Salinity Standard Mapped Image Monthly Data V5.0',
                     'original_dataset_url':'https://podaac.jpl.nasa.gov/dataset/AQUARIUS_L3_SSS_SMI_MONTHLY_V5',
                     'original_dataset_reference':'AQUARIUS_L3_SSS_SMI_MONTHLY_V5',
                     'original_dataset_product_id':'10.5067/AQR50-3SMCS'}
    
    # get filename format information
    data_file_suffix = '1deg'
