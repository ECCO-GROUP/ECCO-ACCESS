...
# generalized_path = Path('./generalized_functions')
...
if __name__== "__main__":
    ...
    source_grid_min_L, source_grid_max_L, source_grid = ea.generalized_grid_product(product_name,
                                                                                    data_res,
                                                                                    data_max_lat,
                                                                                    area_extent,
                                                                                    dims,
    ...
    for data_field_info in data_fields :
        ...
        for year in years:
            ...
            data_shortest_DA_year_merged = ea.generalized_process_loop_local(data_field_info,
                                                         data_dir,
                                                         iso_dates_for_year,
                                                         paths,
                                                         source_indices_within_target_radius_i,
            ...
            ea.generalized_aggregate_and_save(data_shortest_DA_year_merged,
                                              new_data_attr,
