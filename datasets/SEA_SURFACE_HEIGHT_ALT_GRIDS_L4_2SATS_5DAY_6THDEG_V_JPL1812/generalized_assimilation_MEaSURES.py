...
#           -- Used when defining the new grid in gf.generalized_grid_product(). Default is: 
#              -- 'area_id':'longlat'
...
if __name__== "__main__":
    ...
    new_data_attr = {'original_dataset_title':'MEaSUREs Gridded Sea Surface Height Anomalies Version 1812',
                     ...
                     'original_dataset_reference':'SEA_SURFACE_HEIGHT_ALT_GRIDS_L4_2SATS_5DAY_6THDEG_V_JPL1812',
                     'original_dataset_product_id':'10.5067/SLREF-CDRV2'}
