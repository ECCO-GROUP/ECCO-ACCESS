...
def make_empty_record(standard_name, long_name, units,
    ...
    data_DA.XC.attrs.pop('coordinates', None)
    data_DA.XC.attrs.pop('long_name', None)
    data_DA.YC.attrs.pop('coordinates', None)
    data_DA.YC.attrs.pop('long_name', None)
    ...
    data_DA.attrs['coordinates'] = 'XC YC time'

    data_DA.i.attrs['axis'] = 'X'
    data_DA.j.attrs['axis'] = 'Y'
    data_DA.i.attrs['swap_dim'] = 'XC'
    data_DA.j.attrs['swap_dim'] = 'YC'
    data_DA.name = variable_name
