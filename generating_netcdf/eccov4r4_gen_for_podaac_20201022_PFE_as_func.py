...
sys.path.append('/home5/ifenty/git_repos_others/ECCO-ACCESS/ecco-cloud-utils')
...
def generate_netcdfs(output_freq_code, job_id:int, num_jobs:int, \
    ...
    mapping_factors_dir = Path('/nobackupp2/ifenty/podaac/lat-lon/mapping-factors')
    ...
    ## METADATA
    metadata_json_dir = Path('/home5/ifenty/git_repos_others/ECCO-ACCESS/metadata/ECCOv4r4_metadata_json')
    ...
    ## ECCO GRID 
    ecco_grid_dir = '/nobackupp2/ifenty/podaac/'
