...
set base_dir = '/nobackupp2/ifenty/podaac_20201216/native/mon_mean/'
set run_description = 'update_valid_minmax_calculate_and_apply_native_mon_mean'
set calculate_valid_minmax = 'True'
set calculate_valid_minmax_method = 'hard'
