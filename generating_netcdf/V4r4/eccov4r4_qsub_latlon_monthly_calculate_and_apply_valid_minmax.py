...
#PBS -l select=2:ncpus=7:model=bro
#PBS -q normal
...
set base_dir = '/nobackupp2/ifenty/podaac_20201216/lat-lon/mon_mean/'
set run_description = 'update_valid_minmax_calculate_and_apply_latlon_mon_mean'
