...
#PBS -l select=4:ncpus=5:model=bro
#PBS -q normal
...
set base_dir = '/nobackupp2/ifenty/podaac_20201216/native/day_mean/'
set run_description = 'update_valid_minmax_calculate_native_day_mean'
